...
abstract class $EntitlementCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool isPremium, String? productId});
}
...
class _$EntitlementImpl extends _Entitlement {
  const _$EntitlementImpl({this.isPremium = false, this.productId}) : super._();
  ...
  @override
  String toString() {
    return 'Entitlement(isPremium: $isPremium, productId: $productId)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, isPremium, productId);
...
abstract class _Entitlement extends Entitlement {
  const factory _Entitlement({final bool isPremium, final String? productId}) =
      _$EntitlementImpl;
